...
public class TypedElementImpl extends IdentifiableImpl implements TypedElement {
	...
	protected EClass eStaticClass() {
		return BasePackage.Literals.TYPED_ELEMENT;
	}
	...
	public Classifier getType() {
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BasePackage.TYPED_ELEMENT__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(Classifier newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasePackage.TYPED_ELEMENT__TYPE, oldType, type));
	}
