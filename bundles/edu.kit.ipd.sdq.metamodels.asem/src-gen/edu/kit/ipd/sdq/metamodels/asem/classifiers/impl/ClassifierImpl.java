 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.metamodels.asem.classifiers.impl.ClassifierImpl#getMethods <em>Methods</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ClassifierImpl extends NamedImpl implements Classifier {
	/**
	...
	public EList<Method> getMethods() {
		if (methods == null) {
			methods = new EObjectContainmentEList<Method>(Method.class, this, ClassifiersPackage.CLASSIFIER__METHODS);
		}
		return methods;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ClassifiersPackage.CLASSIFIER__METHODS:
