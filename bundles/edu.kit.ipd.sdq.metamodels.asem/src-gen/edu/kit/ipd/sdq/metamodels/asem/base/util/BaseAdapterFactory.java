/**
 */
package edu.kit.ipd.sdq.metamodels.asem.base.util;

import edu.kit.ipd.sdq.metamodels.asem.base.*;
 ...
 * <!-- end-user-doc -->
 * @see edu.kit.ipd.sdq.metamodels.asem.base.BasePackage
 * @generated
 */
public class BaseAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link edu.kit.ipd.sdq.metamodels.asem.base.TypedElement <em>Typed Element</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
